...
<body>
  <div class="card">
    ...
    <h1>${message}</h1>
    <p>${success ? "You won't receive any more emails from us.<br/>Changed your mind? <a href='https://johntagudin.com'>Re-subscribe here.</a>" : 'Please try again or contact <a href="mailto:hello@johntagudin.com">hello@johntagudin.com</a>.'}</p>
  </div>
</body>
</html>`
}
